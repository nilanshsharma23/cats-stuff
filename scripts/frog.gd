...
@export var croak_range: float = 46.0
@export var aoe_radius: float = 34.0
@export var aoe_damage: int = 2
@export var croak_cooldown: float = 1.4
@export var croak_windup: float = 0.5
